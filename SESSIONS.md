...
|---|---|---|---|---|
| `exam-qa-pack` | **Round 2, Ido 2026-08-24:** more diagrams, charts, icons and images in the HTML half of the examiner pack — inline SVG diagrams and charts plus real app screenshots from `docs/render-passes/` embedded as data URIs. `.docx` unchanged | `docs/exam-prep/` (owns the whole dir), `CHANGELOG/2026-08-24/exam-qa-pack.md` | none — no Gradle, no device | 2026-08-24 |
